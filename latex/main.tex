...
\usepackage{tikz}
\usepackage[backend=biber,style=numeric,sorting=none]{biblatex} % Ensure biblatex is configured correctly
\addbibresource{references.bib} % Ensure the .bib file is correctly specified
\usepackage{array}
