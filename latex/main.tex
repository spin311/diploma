...
Ugotovitve kažejo, da so bile naloge, ki so bile rešene z uporabo ChatGPT-ja, imele za v povprečju izmed 5 možnih doseženih točk za 1,1 točke ali 38 \% procentov boljše rezultate kot naloge, ki so bile rešene samostojno. 
Največja razlika je bila pri reševanju nalog obeh težjih kategorij, kjer je razlika znašala v povprečju 1,6 točke, pri nalogah lažje kategorije pa je razlika bila najmanjša in je znašala le 0,3 točke.
Dodatno rezultati kažejo, da uporaba ChatGPT opazno zmanjša razlike v rezultatih v skupinah z različnim predznanjem, kjer je razlika med skupina z različnim predznanjem brez uporabe ChatGPT znašala kar 1,6 točke, razlika z uporabo ChatGPT pa samo 0,2 točk v prid skupini z več predznanja. Iz ugotovitev lahko sklepamo, da lahko hiter inženiring ob ustrezni uporabi zapolni razkorak med človeško intuicijo in strojno natančnostjo ter tako ponudi učinkovit pristop za reševanje zapletenih izzivov kodiranja in spodbujanje inovacij v inženirstvu programske opreme.
...
\begin{itemize}
    ...
    \item Drugič, ključni cilj ekipe za programsko opremo je nenehno izdelovanje preizkušene delujoče programske opreme. Nove izdaje se pripravljajo v pogostih časovnih intervalih, v nekaterih pristopih celo vsako uro ali vsak dan, vendar bolj običajno na dva meseca ali mesec. 
