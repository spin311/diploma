...
\chapter{Zaključek}
Diplomska naloga je raziskala potencial hitrega inženiringa, podprtega z velikimi jezikovnimi modeli, kot ključno orodje pri razvoju programske opreme. Študija je pokazala, da lahko orodja, kot je ChatGPT, bistveno izboljšajo učinkovitost programiranja, zmanjšajo število napak in pospešijo proces implementacije razvojne opreme. Analiza rezultatov je v povprečju pokazala 23 \% izboljšanje rezultatov pri reševanju nalog v primerjavi z metodami brez podpore UI. Največja razlika se je pokazala pri nalogah težjih težavnostnih kategorij, kjer so naloge z uporabo UI bile v povprečju rešene za 32 \% boljše.

Pomemben prispevek naloge je poudarek na zmanjševanju razkoraka med  razvijalci z različnimi stopnjami predznanja. Uporaba orodij UI ne le pospešuje proces kodiranja, temveč tudi omogoča reševanje težjih izzivov programerjem z manj izkušnjami.
...
Rezultati naloge dokazujejo, da hitri inženiring, podprt z umetno inteligenco, odpira nove možnosti za optimizacijo procesov razvoja programske opreme. Praktični dosežki študije lahko pripomorejo nadaljnjim raziskavam o širši uporabi teh orodij v različnih programerskih okoljih ter njihov vpliv na različne razvojne scenarije.

Naloga zaključuje, da je integracija umetne inteligence v programsko inženirstvo pomemben korak k učinkovitejšemu, natančnejšemu in hitrejšemu razvoju programske opreme, ki bo igrala ključno vlogo v prihodnosti tehnologije.
